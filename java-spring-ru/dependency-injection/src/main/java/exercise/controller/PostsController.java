...
public class PostsController {
    ...
    public Post update(@PathVariable int id, @RequestBody Post post) {
        var postPost = postRepository.findById((long) id).orElseThrow(() -> new ResourceNotFoundException("ResourceNotFoundException"));
        postPost.setTitle(post.getTitle());
        postPost.setBody(post.getBody());
